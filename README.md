...
│   └── index-prediction/              # 技能 4: A股四大指数盘前概率推演与路径预测
├── 每天复盘强势板块分析/               # 📄 每日复盘通用核心主文档
│   └── 每天强势板块产业链共振分析.md
├── 5日内板块轮动分析/                  # 📄 板块轮动分析通用核心主文档
│   └── 5日内板块轮动节奏分析.md
├── 每天行情板块预测/                  # 📄 盘前板块预测通用核心主文档
│   └── 每天行情板块预测.md
├── A股四大指数盘前预测/               # 📄 四大指数盘前推演通用核心主文档
...
- 🗣 *"基于08:30截面，推演今天A股四大指数的方向、运行区间与路径场景"* ➡️ 自动激活 `index-prediction`
...
2. **三维共振与指数差异化**：上证挂钩权重与宏观，深证/创业板挂钩美股科技映射与成长情绪，中证1000挂钩小盘流动性与题材热度。
